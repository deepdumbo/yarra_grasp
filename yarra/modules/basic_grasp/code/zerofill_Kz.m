...
%input as [nx, ntviews, nz_old, nc]
%output as [nx, ntviews, nz_new, nc]
...
% TODO: Verify that this is correct. ivom: it is not. 
%shift=slices/2-centerpartition+1;

%ivom: due to error, I redefine shift as:
shift = floor((newsize(3) - oldsize(3))/2);
